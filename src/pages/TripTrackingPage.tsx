...
const TripTrackingPage: React.FC = () => {
    ...
    return (
      <div style={{ padding: '20px', textAlign: 'center' }}>
        <InfoBox variant="info">
          <strong>Loading...</strong> Loading trips data
        </InfoBox>
      </div>
    );
  }
  ...
  return (
    <div style={{ padding: '20px' }}>
      <h1>Trip Tracking</h1>
      <p>Track ongoing trips and compare planned vs actual routes</p>
            ...
            <div style={{ fontSize: '14px' }}>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '15px' }}>
                ...
                <div>
                  ...
                  <p><strong>Distance Traveled:</strong> {selectedTrip.distanceTraveled} km</p>
                  <p><strong>Remaining Distance:</strong> {selectedTrip.remainingDistance} km</p>
                  <p><strong>Current Speed:</strong> {selectedTrip.vehicle.speed} km/h</p>
                  <p><strong>Average Speed:</strong> {selectedTrip.averageSpeed} km/h</p>
                </div>
              </div>
      ...
      <div style={{ height: '600px', marginBottom: '30px', border: '1px solid #ddd', borderRadius: '8px' }}>
        <LoadScript googleMapsApiKey={process.env.REACT_APP_GOOGLE_MAPS_API_KEY || ""}>
          <GoogleMap
            ...
            center={selectedTrip ? selectedTrip.currentLocation : saudiArabiaCenter}
      ...
      {/* Legend */}
      <Card>
        <h3>Colors and Symbols Guide</h3>
